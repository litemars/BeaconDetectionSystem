...
class ConnectionEvent:
    ...
    def protocol_name(self):
        ...
        return Protocol(self.protocol).name if self.protocol in [6, 17] else f"UNKNOWN({self.protocol})"
    ...
    def __repr__(self):
        ...
        return (f"ConnectionEvent({self.connection_key}{flags_str} "
...
class TelemetryBatch:
    ...
    def __repr__(self):
        return (f"TelemetryBatch(id={self.batch_id}, node={self.node_id}, "
...
class DataPlaneStats:
    ...
    def __repr__(self):
        return (f"DataPlaneStats(total={self.packets_total}, tcp={self.packets_tcp}, "
