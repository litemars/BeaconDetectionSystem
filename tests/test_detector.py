...
class TestIntervalStats:
    ...
    def test_small_jitter(self):
        ...
        base = 60.0
        jitter_range = 2.0
        intervals = [base + random.uniform(-jitter_range, jitter_range) for _ in range(50)]
...
class TestBeaconDetection:
    ...
    def test_confidence_levels(self):
        ...
        assert detector._determine_confidence(0.1, 0.1, 0.1, 0.1) == BeaconConfidence.NONE
        assert detector._determine_confidence(0.4, 0.4, 0.4, 0.4) == BeaconConfidence.LOW
        assert detector._determine_confidence(0.6, 0.6, 0.6, 0.6) == BeaconConfidence.MEDIUM
        assert detector._determine_confidence(0.8, 0.8, 0.8, 0.8) == BeaconConfidence.HIGH
    ...
    def test_batch_analyze(self):
        ...
        # Regular beacon
        pairs.append(self.create_connection_pair(
